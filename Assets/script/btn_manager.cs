...
public class Login
{
    ...
    //public chillLogin attribute { get; set; }
}

[System.Serializable]
public class chillLogin
{
...
{
    public List<Nama> Namanama { get; set; }
}
...
[Serializable]
public class NamaRoot
{
    public NamaChildd [] attribute;
}
...
{
    public static btn_manager Control;
    public string token;
    public string id;
    ...
    public void level1()
    {
        ...
        {
            SceneManager.LoadScene("level1_resize");
        }
        else
        {
    ...
    public void level4B()
    {
        SceneManager.LoadScene("level4B_resize");
    }
    public void level5A()
    {
        SceneManager.LoadScene("level5A_resize");
    }
    public void level5B()
    {
        SceneManager.LoadScene("level5B_resize");
    } 
    public void level6()
    {
        SceneManager.LoadScene("level6_resize");
    }
    ...
    IEnumerator login()
    {
        ...
        using (
            UnityWebRequest www = UnityWebRequest.Post("http://game.psikologicare.com/api/login?name=" + nama + "&password=" + pass + "", form))
        {
