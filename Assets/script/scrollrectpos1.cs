...
public class scrollrectpos1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (bawah == true)
        {
            ...
            for (int i = 0; i <= bentuk_image.Length - 1; i++)
            {
                ...
                {
                    //Debug.Log("kebawah" + i);
                    //bentuk_image[i].GetComponent<ItemIDragHandler2_rotate>().enabled = false;
                    bentuk_image[i].GetComponent<ItemIDragHandler2_rotate>().btn_rotate.SetActive(false);
                    bentuk_image[i].GetComponent<ItemIDragHandler2_rotate>().btn_flip.SetActive(false);
                }
            }
        }
        else
        {
            ...
            for (int i = 0; i <= bentuk_image.Length -1; i++)
            {
                if (bentuk_image[i].transform.parent == scroll.transform)
                {
                    bentuk_image[i].GetComponent<ItemIDragHandler2_rotate>().enabled = true;
                }
            }
        }
