...
public class SendScoreApi : MonoBehaviour
{
    ...
    IEnumerator UploadJPG()
    {
        ...
        //error.text = encode.ToString();
        // Upload to a cgi script
        UnityWebRequest w = UnityWebRequest.Post("https://game.psikologicare.com/api/game/store-image", form2);
