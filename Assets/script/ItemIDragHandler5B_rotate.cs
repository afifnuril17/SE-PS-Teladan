...
public class ItemIDragHandler5B_rotate : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler, IBeginDragHandler, IEndDragHandler
{
	...
	{
		if (o_panel.GetComponent<scrollrectpos5B>().bawah == false || bentuk_image.transform.parent == GameObject.Find("objek_dibuat").transform)
		{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
		...
		waktu = 0;
		o_panel.GetComponent<scrollrectpos5B>().balik();
		...
		if(o_panel.GetComponent<scrollrectpos5B>().bawah == true)
        {
        ...
        else
        {
			...
			o_panel.GetComponent<scrollrectpos5B>().kebawah();
		}
