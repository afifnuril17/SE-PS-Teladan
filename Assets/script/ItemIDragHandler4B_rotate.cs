...
public class ItemIDragHandler4B_rotate : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler, IBeginDragHandler, IEndDragHandler
{
	...
	{
		if (o_panel.GetComponent<scrollrectpos4B>().bawah == false || bentuk_image.transform.parent == GameObject.Find("objek_dibuat").transform)
		{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
		...
		waktu = 0;
		o_panel.GetComponent<scrollrectpos4B>().balik();
		...
		if(o_panel.GetComponent<scrollrectpos4B>().bawah == true)
        {
        ...
        else
        {
			...
			o_panel.GetComponent<scrollrectpos4B>().kebawah();
		}
