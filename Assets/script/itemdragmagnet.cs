...
public class itemdragmagnet : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler, IBeginDragHandler, IEndDragHandler
{
	...
	void OnTriggerStay2D(Collider2D col)
	{
		...
		//if (col.gameObject.CompareTag("bentuk"))
		//{
			//if (magnet == 1)
			//{
				//GameObject ben = GameObject.FindGameObjectWithTag("bentuk");
				//Debug.Log(ben.transform);
				//Debug.Log("Melekat");
				//bentuk_image.transform.position = ben.transform.position;
				//bentuk_image.transform.rotation = ben.transform.rotation;
			//}
